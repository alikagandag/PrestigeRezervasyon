...
namespace PrestigeRezervasyon
{
    public static class DbInitializer
    {
        private static string connectionString = "Data Source=..\\..\\files\\PrestigeRezervasyonDb.db;Version=3;";

        public static void InitializeDatabase()
        {
            if (!File.Exists("..\\..\\files\\PrestigeRezervasyonDb.db")) 
            {
                SQLiteConnection.CreateFile("..\\..\\files\\PrestigeRezervasyonDb.db");
                using (var connection = new SQLiteConnection(connectionString))
                {
                    ...
                    INSERT INTO Film (FilmAdi) VALUES ('Fight Club');
                    INSERT INTO Film (FilmAdi) VALUES ('Tenet');
                    INSERT INTO Film (FilmAdi) VALUES ('Inception');
                    INSERT INTO Film (FilmAdi) VALUES ('Shutter Island');";
